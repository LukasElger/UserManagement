...
RSpec.describe "contur/databases/edit", type: :view do
  ...
  describe "contains a edit form for a database" do
    it "header" do
      expect(rendered).to have_selector('h1', text: I18n.t("contur/database.edit.header"))
    ...
    it "edit form content" do
      assert_select "form" do
        ...
        assert_select "input[name='contur_database[contur_type]']"
    ...
    it "contains footer / buttons" do
      expect(rendered).to have_selector('h2', text: I18n.t("contur/database.edit.footer"))
